    ...
    <script>
        function Deleteqry(id)
        {
            if (confirm("Are you sure you want to delete this user?") == true)
                window.location = "genp.php?del=" + id;
            return false;
        }
        ...
        function acptqry(id)
        {
            if (confirm("Are you sure you want to accept this user?") == true)
                window.location = "genp.php?acpt=" + id;
            return false;
        }
        ...
        function actvqry(id)
        {
            if (confirm("Are you sure you want to active this user?") == true)
                window.location = "genp.php?actv=" + id;
            return false;
        }
        ...
        function inac(id)
        {
            if (confirm("Are you sure you want to inactive this user?") == true)
                window.location = "genp.php?inac=" + id;
            return false;
        }
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Medical Consultant Details</h4>
                                        </div>
                                ...
                                <div class="box-content">
                                    ...
                                    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM user where user_type='G'";
