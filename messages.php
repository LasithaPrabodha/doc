                            ...
                            <fieldset>
                                ...
                                if(isset($_POST['send'])) {
                                    ...
                                    if ($_POST['to'] == -1) {
                                        ...
                                        $sql = "INSERT INTO messages(`sender_id`, `reciever_id`, `title`, `message`, `sent_at`) VALUES(" . $_SESSION['user_id'] . "," . $_POST['to'] . ",'" . $_POST['title'] . "','" . $_POST['message'] . "','" . date("Y-m-d H:i:s") . "')";
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <select id="to" name="to" class="form-control">
                                            <option value="-1">Please select a Medical Consultant</option>
                                            <?PHP
                                            $sql = "SELECT CONCAT(user.first_name, ' ', user.last_name) AS name,user_id FROM user WHERE user_type='G' AND is_active=1";
